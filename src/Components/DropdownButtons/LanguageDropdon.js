...
const LanguageDropdown = ({ languages }) => {
  ...
  return (
    <div className='flex justify-center items-center ltr:mr-[29px] rtl:ml-[29px] relative'>
      ...
      <ul className={`shadow-md w-max h-fit absolute border rounded-xl z-10 top-[70px] text-center transition duration-300 bg-white ${isOpen ? "opacity-100 visible" : "opacity-0 invisible"}`}>
